...
aimlockconfigtab:AddSlider("AutoFireDelay", { Text = "Auto-Fire Delay (W.I.P)", Default = 17, Min = 1.7, Max = 30, Rounding = 2, Suffix = "s", Callback = function(v) autoFireDelay = v end })
...
Library.ToggleKeybind = Options.MenuKeybindlocal xrayenabled = false
local xraytransparency = 0.6
local originaltransparencies = {}
local noVelocityEnabled = false
local noVelocityConnection = nil
